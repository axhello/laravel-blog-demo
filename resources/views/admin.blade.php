  ...
  <body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              <li>
                <a href="{{ url('/') }}" target="_blank">
                  <i class="fa fa-home fa-lg" title="前台首页"></i>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i>自己开发 233</a></li>
              </ul>
            </li>
          </ul>
        </section>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015 <a href="#">mango</a>.</strong> All rights reserved.
      </footer>
